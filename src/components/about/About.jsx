...
const About = () => {
    ...
    if (!localStorage.getItem('selfieImage')) {
        localStorage.setItem('selfieImage', selfie);
    }
    var selfieImage = localStorage.getItem('selfieImage');
        ...
        <section id="about">
            ...
            <div className="container about__container">
                <div className="about__me">
                    <img src={selfieImage} alt="About me" />
                </div>
